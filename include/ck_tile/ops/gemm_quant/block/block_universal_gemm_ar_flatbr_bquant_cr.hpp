                ...
                static_for<0, NIterPerWarp, 1>{}([&](auto nIter) {
                    ...
                    static_for<0, WG::kM * WG::kN / warp_size, 1>{}([&](auto c_row) {
                        ...
                        if(get_block_id() == 0 && get_warp_id() == 0 && get_thread_id() == 0){
                            printf("scale_reg_f: %f, reg_offset: %d, c_row: %d, get_block_id(): %d, get_warp_id(): %d, get_thread_id(): %d \n", 
                                scale_reg_f, reg_offset, static_cast<int>(c_row), get_block_id(), get_warp_id(), get_thread_id());
