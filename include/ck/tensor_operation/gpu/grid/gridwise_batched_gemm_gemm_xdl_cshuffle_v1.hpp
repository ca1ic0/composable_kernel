...
#if 0
        constexpr index_t Gemm1AMmaKStride =  MfmaSelector<FloatAB, MPerXdl, NPerXdl>::selected_mfma.group_size;
        constexpr index_t Gemm1KPack =  MfmaSelector<FloatAB, MPerXdl, NPerXdl, FloatAB, false>::
